...
class UserManager(models.Manager):
    ...
    def register(self, **kwargs):
        ...
        elif len(User.objects.filter(email) > 0:
        ...
        if not messages:
            ...
            User.userManager.create(first_name = fname, last_name = lname, email = email, password = password, birthday = birthday)
        else:
            valid = False
